...
if (function_exists('add_theme_support'))
{
	...
	add_image_size('blog-thumb',200,'',true); // Blog thumbnail size
...
function footer_nav()
{
	...
	array(
		...
		'container'       => 'div', 
		'container_class' => 'menu-{menu slug}-container', 
		'container_id'    => 'mobile_footer_nav',
		'menu_class'      => 'menu', 
		'menu_id'         => '',
		'echo'            => true,
		'fallback_cb'     => 'wp_page_menu',
...
function footer_mobile_nav()
{
	...
	array( 
		...
		'menu'            => 'footer_mobile_nav', 
		'container'       => 'div', 
		'container_class' => 'menu-{menu slug}-container', 
		'container_id'    => 'footer_mobile_nav',
		'menu_class'      => 'menu', 
		'menu_id'         => 'footer_mobile_nav',
		'echo'            => true,
		'fallback_cb'     => 'wp_page_menu',
		'before'          => '',
		'after'           => '',
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'footer-mobile-menu' => __('Footer Mobile Menu', 'html5blank') // Extra Navigation if needed (duplicate as many as you need!)
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Widgets for the header.'),
        'id' => 'header-widgets',
...
// I don't want to hide the admin bar - JAA
...
// Add editor (the_content) to Meteor Slides

// replaced excerpt with editor for more functionality
//add_post_type_support('slide', 'excerpt');
//updated 20121113 JAA
...
function html5_shortcode_demo_2($atts, $content = null) // Demo Heading H2 shortcode, allows for nesting within above element. Fully expandable.
{
	...
	/*
	 * Adds JavaScript for drop-down and accordion menu.
	 */
	wp_enqueue_script( 'tessdropdowns', get_template_directory_uri() . '/js/tessdropdowns/script.js', array(), '1.0', true );

function tessdropdownstyles()
{
    wp_register_style('tessdropdown', get_template_directory_uri() . '/js/tessdropdowns/style.css', array(), '1.0', 'all');
    wp_enqueue_style('tessdropdown'); // Enqueue it!
}
